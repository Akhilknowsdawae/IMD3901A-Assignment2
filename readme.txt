...
I've had trouble coding out the destruction of objects with requirements. I've tried to code a javascript file (forge-logic.js) that deletes an ingot if you bring it near the forge and increment a variable, 
...
As well as item pickup which auto rotates the ingot into its initial rotation when placed back down.
